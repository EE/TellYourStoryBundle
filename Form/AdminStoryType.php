...
class AdminStoryType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add(
                ...
                'entity',
                array(
                    'label' => 'tys.form.story.story_collections.label',
                    'help_block' => 'tys.form.story.story_collections.help_block',
                    'class' => 'EE\TYSBundle\Entity\StoryCollection',
                    'property' => 'name',
                    'multiple' => true,
                    'expanded' => true
                )
    ...
    {
        return 'ee_tysbundle_adminstorytype';
    }
